  ...
  return (
    <div className="bg-[#1E1E1E] rounded-lg overflow-hidden flex flex-col mb-6">
      ...
      <div className="px-4 pb-4">
        {trackUrl && (
          <div className="mb-1">
            <div className="w-full h-12 bg-[#282828] rounded-md relative">
              {/* Simple progress bar */}
              <div 
            ...
            {stems.length === 0 ? (
              ...
              <>
                ...
                {(showAllStems ? stems : stems.slice(0, 3)).map(stem => (
                  <div
                    key={stem.id}
                    className="flex flex-col p-3 bg-[#282828] rounded-lg mb-3"
                  >
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        {isStemInCart(stem) ? (
                          <button
                            ...
                            className="text-white bg-[#333] hover:bg-[#444] px-3 py-1.5 rounded text-sm transition-colors flex items-center"
                          >
                            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
